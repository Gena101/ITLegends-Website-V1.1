...
const schema = [
  {
    ...
    '@type': 'LocalBusiness',
    '@id': 'https://www.itlegends.co.za/#it-legends-centurion',
    'name': 'IT Legends – Centurion',
    'url': 'https://www.itlegends.co.za/it-support-centurion',
    'telephone': '+27-84-634-8144',
    'email': 'info@itlegends.co.za',
    'description': 'Managed IT support, cybersecurity, cloud and network solutions for businesses in Centurion and greater Pretoria.',
    'address': {
      '@type': 'PostalAddress',
  ...
  },
  {
    ...
    'mainEntity': [
      {
        '@type': 'Question',
        'name': 'Who provides IT support in Centurion?',
        'acceptedAnswer': {
          '@type': 'Answer',
          'text': 'IT Legends provides managed IT support, cybersecurity, cloud and network solutions for businesses in Centurion. Our office is based in Wierdapark, Centurion, giving us fast response times across the area.',
        },
      },
      {
        '@type': 'Question',
        'name': 'How quickly can IT Legends respond to IT problems in Centurion?',
        'acceptedAnswer': {
          '@type': 'Answer',
          'text': 'IT Legends provides remote support immediately and can be on-site in Centurion within hours for critical issues. Our Wierdapark office means we are always close by.',
        },
      },
      {
        '@type': 'Question',
        'name': 'What IT services does IT Legends offer in Centurion?',
        'acceptedAnswer': {
          '@type': 'Answer',
          'text': 'IT Legends offers managed IT support, cybersecurity, cloud and backup solutions, server maintenance, hardware and network setup, and helpdesk support for businesses in Centurion and greater Pretoria.',
        },
      },
      {
        '@type': 'Question',
        'name': 'How much does IT support cost for a small business in Centurion?',
        'acceptedAnswer': {
          '@type': 'Answer',
          'text': 'IT Legends offers scalable managed IT support packages tailored to SME budgets in Centurion. Contact us on +27 84 634 8144 for a free assessment and custom quote.',
        },
      },
      {
        '@type': 'Question',
        'name': 'Does IT Legends offer a free IT assessment in Centurion?',
        'acceptedAnswer': {
          '@type': 'Answer',
          'text': 'Yes. IT Legends offers a free IT health check for businesses in Centurion. We assess your current IT environment and recommend solutions tailored to your needs and budget.',
        },
      },
    ],
  },
...
const services = [
  { icon: Shield, title: 'Managed IT Support', desc: 'Proactive monitoring, maintenance and remote support — your outsourced IT department in Centurion.', color: 'red', href: '/services/managed-it-support', highlight: true },
  { icon: Shield, title: 'Cybersecurity', desc: 'Endpoint protection, firewall management and threat detection to keep your Centurion business safe.', color: 'blue', href: '/services/cybersecurity', highlight: false },
  ...
  { icon: Users, title: 'Helpdesk Support', desc: 'Fast remote helpdesk assistance for day-to-day IT problems across your Centurion team.', color: 'blue', href: '/services/helpdesk', highlight: false },
];

export default function ITSupportCenturion() {
  return (
    <div className="min-h-screen bg-itdark text-itsilver">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-16">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
            IT Support in <span className="bg-gradient-to-r from-itred to-itblue text-transparent bg-clip-text">Centurion</span>
          </h1>
          <p className="text-lg sm:text-xl text-itsilver mb-10 leading-relaxed max-w-2xl mx-auto">
            Local managed IT support, cybersecurity and cloud solutions for Centurion businesses. Fast response times. Certified technicians. Fixed monthly costs.
          </p>
      ...
      <section className="relative py-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-white mb-6">Centurion's Local IT Partner</h2>
          <div className="section-divider mb-8"></div>
          <p className="text-itsilver text-lg leading-relaxed mb-6">
            IT Legends is based in Wierdapark, Centurion — giving us faster on-site response times than any Pretoria CBD-based IT company. When your server goes down or your network fails, you need someone who can be there quickly. We can.
          </p>
          <p className="text-itsilver text-lg leading-relaxed">
            We support small and medium businesses across Centurion, Irene, Hennopsrivier, Lyttelton and greater Pretoria — acting as your dedicated IT department for a predictable monthly cost.
          </p>
        </div>
      </section>
      ...
      <section className="relative py-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="section-title">IT Services in Centurion</h2>
            <div className="section-divider mb-6"></div>
            <p className="text-itsilver max-w-2xl mx-auto">Everything your Centurion business needs — from daily helpdesk support to full cybersecurity protection.</p>
          </div>
      ...
      <section className="relative py-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-white mb-4">Centurion IT Support FAQs</h2>
      ...
      <section className="relative py-16 px-4 sm:px-6 lg:px-8 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-xl mx-auto">
          <h2 className="text-3xl font-bold text-white mb-4">Ready to get legendary IT support in Centurion?</h2>
